...
# Bot API Token
API_TOKEN = '6219231457:AAEj667LNm2lp9WNiLJx7f9StfffTSpoG5s'
API_ID ='27733303'
API_HASH ='c3c9d5e5d89c99fb8bb85a22a0cb5a26'
# OpenAI API Key
openai.api_key = "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"
#Only owner id
DEVIL = "1965898154"
# MongoDB setup
MONGODB_URI = "mongodb+srv://krisanjits:DvMRAuHGxGJSqA0Z@cluster0.zdoglje.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp"  # Set your MongoDB connection string here
client = pymongo.MongoClient(MONGODB_URI)
db = client["wormgpt"]
collection = db["allowed_users"]
allowed_users = ["K_HACKER_ANONYMOUS", "AM_YTBOTT", "Mr_majnu72"]
owners = ["K_HACKER_ANONYMOUS", "AM_YTBOTT", "Mr_majnu72"]
...
def cod3(_,message):
    if message.from_user.username in allowed_users:
        ...
        message.reply( "𝚂𝚘𝚛𝚛𝚢, 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚗𝚘𝚝 𝚊𝚞𝚝𝚑𝚘𝚛𝚒𝚣𝚎𝚍 𝚝𝚘 𝚋𝚘𝚝 𝙱𝚞𝚢 𝙱𝚘𝚝 𝙵𝚛𝚘𝚖 @DARK_WORM_GPT_AI")
...
def start_bot(client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="Owner Of Bot", url=f"https://t.me/K_HACKER_ANONYMOUS"),
            ],
            [
                InlineKeyboardButton(text="Buy Subscription", callback_data="help"),
                InlineKeyboardButton(text="About This Bot", callback_data="about"),
            ],
            [
             InlineKeyboardButton(text="Ai Developers", callback_data="admin"),
    ...
    start_message = app.send_message(
        message.chat.id,
        """𝙷𝚎𝚕𝚕𝚘 𝚂𝚒𝚛 ! 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚃𝚘 𝚆𝚘𝚛𝚖 𝙶𝙿𝚃 𝙰𝚒 ! 𝙿𝚕𝚎𝚊𝚜𝚎 click on the Auth cmds button 𝙵𝚘𝚛 𝚂𝚎𝚎 𝙵𝚎𝚊𝚝𝚞𝚛𝚎𝚜""",
...
def admin_callback(client, callback_query):
    ...
    app.send_message(
        callback_query.message.chat.id,
        """
𝙳𝙰𝚁𝙺 𝚆𝙾𝚁𝙼 𝙶𝙿𝚃 𝙰𝙸 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁𝚂 𝙻𝙸𝚂𝚃 

𝕄𝔸𝕀ℕ 𝔻𝔼𝕍 :- @K_HACKER_ANONYMOUS 
𝔻𝔼𝕍 𝔹ℝ𝕆𝕋ℍ𝔼ℝ :- @Mr_majnu72
...
def help_callback(client, callback_query):
    ...
    app.send_message(
        callback_query.message.chat.id,
        """
𝙸𝚏 𝚈𝚘𝚞 𝙽𝚎𝚎𝚍 𝙱𝚘𝚝 𝙰𝚞𝚝𝚑 𝚂𝚘 𝙳𝚖 𝙾𝚗 𝙾𝚠𝚗𝚎𝚛 𝙱𝚞𝚝𝚝𝚘𝚗 👇🏻
        """,
        reply_markup=keyboard
    )
    ...
    if message.from_user.username in owners:
        ...
        if len(user_to_remove) == 0:
            ...
            if user_to_remove in allowed_users:
                ...
                app.send_message(message.chat.id, f"𝚄𝚜𝚎𝚛 {user_to_remove} 𝚒𝚜 𝚗𝚘𝚝 𝚒𝚗 𝚝𝚑𝚎 𝚕𝚒𝚜𝚝𝚘𝚏 𝚊𝚞𝚝𝚑𝚘𝚛𝚒𝚣𝚎𝚍 𝚞𝚜𝚎𝚛𝚜.")
...
def send_answer(client, message):
    if message.from_user.username in allowed_users:
        ...
        app.send_message(message.chat.id, "𝚂𝚘𝚛𝚛𝚢, 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚗𝚘𝚝 𝚊𝚞𝚝𝚑𝚘𝚛𝚒𝚣𝚎𝚍 𝚝𝚘 𝚋𝚘𝚝 𝙱𝚞𝚢 𝙱𝚘𝚝 𝙵𝚛𝚘𝚖 @DARK_WORM_GPT_AI")
